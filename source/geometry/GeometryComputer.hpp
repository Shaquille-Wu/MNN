...
//Shaquille, Added 20210214 Start
        void set_first_backend(std::shared_ptr<Backend> first_backend) { first_backend_ = first_backend; };
        std::shared_ptr<Backend> get_first_backend()                   { return first_backend_ ;};
//Shaquille, Added 20210214 End
    ...
    private:
        ...
        bool mPermitVirtual;
//Shaquille, Added 20210214 Start
        std::shared_ptr<Backend> first_backend_;
//Shaquille, Added 20210214 End
