...
//Shaquille, Added 20201105 Start
    using clEnqueueCopyBufferToImageFunc = cl_int (CL_API_CALL *)(cl_command_queue,
                                                                  cl_mem,
                                                                  cl_mem,
                                                                  size_t,
                                                                  const size_t*,
                                                                  ...
                                                                  const cl_event*,
                                                                  cl_event*);
    using clEnqueueCopyImageToBufferFunc = cl_int (CL_API_CALL *)(cl_command_queue,
                                                                  cl_mem,
                                                                  cl_mem,
                                                                  const size_t*,
                                                                  const size_t*,
...
//Shaquille, Added 20201105 End
    ...
    using clCreateKernelsInProgramFunc  = cl_int (CL_API_CALL *)(cl_program, cl_uint, cl_kernel*, cl_uint*);
...
#define MNN_CL_DEFINE_FUNC_PTR(func) func##Func func = nullptr
    ...
    MNN_CL_DEFINE_FUNC_PTR(clCreateKernelsInProgram);
...
//Shaquille, Added 20201105 Start
    MNN_CL_DEFINE_FUNC_PTR(clEnqueueCopyBufferToImage);
    MNN_CL_DEFINE_FUNC_PTR(clEnqueueCopyImageToBuffer);
//Shaquille, Added 20201105 End
