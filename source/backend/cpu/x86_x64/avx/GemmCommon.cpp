...
D##v##u = _mm256_add_epi32(D##v##u, _mm256_madd_epi16(W##u, S##v));
    ...
    if (4 == realDst) {
        ...
        __m256i D20 = _mm256_setzero_si256();
        __m256i D21 = _mm256_setzero_si256();
        __m256i D22 = _mm256_setzero_si256();
        __m256i D23 = _mm256_setzero_si256();

        __m256i D30 = _mm256_setzero_si256();
        __m256i D31 = _mm256_setzero_si256();
        __m256i D32 = _mm256_setzero_si256();
        __m256i D33 = _mm256_setzero_si256();
#endif
