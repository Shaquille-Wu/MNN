...
//Shaquille, Added 20210226 Start
        {
            auto in_tensor_fmt0 = TensorUtils::getDescribe(input0)->dimensionFormat;
            auto in_tensor_fmt1 = TensorUtils::getDescribe(input1)->dimensionFormat;
