...
//Shaquille, Added 20200902 Start
    int     getInputTensorIdx(const char* name) const;
    int     getOutputTensorIdx(const char* name) const;
...
//Shaquille, Added 20201108 Start
	Tensor*   CreateIOTensor(Tensor* src_tensor, int tensor_io_type, int tensor_dime_type);
