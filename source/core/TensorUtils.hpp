...
//Shaquille, Added 20201117 Start
		/** host memory is shared with backend, just for qcom's ion_buf */
		MEMORY_HOST_BACKEND_SHARED
...
//Shaquille, Added 20201108 Start
	/** some tensor just pending in the network, but, it didn't be called by any one, such as split's output. */
	bool fake_used = false;
