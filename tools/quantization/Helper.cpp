...
//Shaquille, Modified 20210204 Start
#if 0
...
std::set<MNN::OpType> Helper::gNeedFeatureOpType = { MNN::OpType_Convolution, MNN::OpType_ConvolutionDepthwise, MNN::OpType_Eltwise };
#endif
//Shaquille, Modified 20210204 End
