...
//Shaquille, Modified 20201129 Start
#if 0
        MobilenetV2Utils::train(model, 1001, 1, trainImagesFolder, trainImagesTxt, testImagesFolder, testImagesTxt);
#else
        MobilenetV2Utils::orion_train(model, 4, 0, trainImagesFolder, trainImagesTxt, testImagesFolder, testImagesTxt, 0);
#endif        
//Shaquille, Modified 20201129 End
        return 0;
    }
};
