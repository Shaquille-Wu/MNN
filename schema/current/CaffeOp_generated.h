...
//Shaquille, Added 20210227 Start
struct GridSample;
struct GridSampleT;
//Shaquille, Added 20210227 End
...
struct GridSampleT : public flatbuffers::NativeTable {
  ...
  int     padding_mode;
  bool    align_corners;
  GridSampleT():mode(0), padding_mode(0), align_corners(false){
  }
};
...
struct GridSample FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  int32_t padding_mode() const {
    return GetField<int32_t>(VT_PADDING_MODE, 0);
  }
  bool align_corners() const {
    return GetField<uint8_t>(VT_ALIGN_CORNDERS, 0) != 0;
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int32_t>(verifier, VT_MODE) &&
           VerifyField<int32_t>(verifier, VT_PADDING_MODE) &&
           VerifyField<uint8_t>(verifier, VT_ALIGN_CORNDERS) &&
           verifier.EndTable();
  }
...
struct GridSampleBuilder {
  ...
  void add_mode(int32_t mode) {
    fbb_.AddElement<int32_t>(GridSample::VT_MODE, mode, 0);
  }
  void add_padding_mode(int padding_mode) {
    fbb_.AddElement<int32_t>(GridSample::VT_PADDING_MODE, padding_mode, 0);
  }
  void add_align_corners(bool align_corners) {
    fbb_.AddElement<uint8_t>(GridSample::VT_ALIGN_CORNDERS, static_cast<uint8_t>(align_corners), 0);
  }
...
inline flatbuffers::Offset<GridSample> CreateGridSample(flatbuffers::FlatBufferBuilder &_fbb, const GridSampleT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return MNN::CreateGridSample(_fbb, _mode, _padding_mode, _align_corners);
}
//Shaquille, Added 20210227 End
